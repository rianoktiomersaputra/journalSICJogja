...
<body style="background-image: url('../gambar/background.jpg'); background-size:cover; ">
    <div class=" container">
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <a class="navbar-brand" href="#">SIC Siswa</a>
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="tabel_siswa.php">Daftar Jurnal</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="siswa.php?id_siswa=<?= $id_siswa ?>">Akun</a>
                </li>
            </ul>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="siswa.php?id_siswa=<?= $id_siswa ?>">Akun Siswa</a></li>
                <li class="breadcrumb-item active" aria-current="page">Edit Akun Siswa</li>
            </ol>
        </nav>
        ...
        <div class="jumbotron jumbotron-fluid" style="opacity:0.8">
            <div class="container">
                <div style="padding:20px;">
                    ...
                    <form action="../proses/proses_edit_akun_siswa1.php" method="POST">
                        <div class="row">
                            <div class="col-md-7">
